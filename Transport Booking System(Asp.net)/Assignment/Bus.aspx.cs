...
namespace Assignment
{
    public partial class Bus : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {               
                if(Request["__EVENTTARGET"] == "btnDepart")
                {
                    ...
                    Session["departTrip"] = Request["__EVENTARGUMENT"];
                ...
                {
                    Session["selected"] = "seleted";
                    Session["returnTrip"] = Request["__EVENTARGUMENT"];
                    Response.Redirect("Calculation.aspx");
                }
            }
        ...
        protected void bttSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Bus.aspx" + "?trip=" + Server.UrlEncode(rblTrip.Text) + "&from=" + Server.UrlEncode(txtFrom.Text) + "&to=" + Server.UrlEncode(txtTo.Text) + "&fromDate=" + Server.UrlEncode(txtFromDate.Text) + "&toDate=" + Server.UrlEncode(txtToDate.Text));
            }
