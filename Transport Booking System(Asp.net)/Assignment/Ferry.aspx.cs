...
{
    public partial class Ferry : System.Web.UI.Page
    {
        public string date = "";
        
        protected void Page_Load(object sender, EventArgs e)
        {
            Session["link"] = "Ferry.aspx";
        ...
        protected void bttSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Ferry.aspx" + "?trip=" + Server.UrlEncode(rblTrip.Text) + "&from=" + Server.UrlEncode(txtFrom.Text) + "&to=" + Server.UrlEncode(txtTo.Text) + "&fromDate=" + Server.UrlEncode(txtFromDate.Text) + "&toDate=" + Server.UrlEncode(txtToDate.Text));
            }
