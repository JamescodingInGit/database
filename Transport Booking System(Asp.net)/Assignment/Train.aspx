<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Train.aspx.cs" Inherits="Assignment.Train" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="busForm" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [ScheduleSelection] WHERE (([transportType] = @transportType) AND ([from] = @from) AND ([to] = @to) AND ([date] = @date))">
            <SelectParameters>
                <asp:Parameter DefaultValue="Train" Name="transportType" Type="String" />
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Train" Name="transportType" />
